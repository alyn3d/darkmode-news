(function(){
  ...
  var transparentElements = document.querySelectorAll('.media--overlay');
  transparentElements.style.setProperty('background-color', 'rgba(0,0,0,0.5)', 'important');
})();